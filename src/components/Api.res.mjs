...
async function fetchClothing() {
  ...
  return Core__Option.getExn(Core__Option.map(Js_json.decodeArray(data), (function (array) {
                    return array.map(function (item) {
                                ...
                                return {
                                        id: Core__Option.getExn(Js_json.decodeNumber(Core__Option.getExn(Js_dict.get(object, "id"), undefined)), undefined) | 0,
                                        name: Core__Option.getExn(Js_json.decodeString(Core__Option.getExn(Js_dict.get(object, "name"), undefined)), undefined),
                                        price: Core__Option.getExn(Js_json.decodeNumber(Core__Option.getExn(Js_dict.get(object, "price"), undefined)), undefined),
                                        imageUrl: Core__Option.getExn(Js_json.decodeString(Core__Option.getExn(Js_dict.get(object, "imageUrl"), undefined)), undefined)
                                      };
                              });
                  })), undefined);
}
